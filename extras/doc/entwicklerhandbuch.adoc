...
.Use Cases für den Microservice "verein"
...
.Komponenten des Microservice "verein"
...
."VereinGetController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,VereinGetController,svg]
----
include::./VereinGetController.plantuml[]
----

.Die Klasse "VereinModel" für den Datenaustausch bei GET
[plantuml,VereinModel,svg]
----
include::./VereinModel.plantuml[]
----

."VereinWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,VereinWriteController,svg]
----
...
.Die Service-Klasse "VereinReadService" im Anwendungskern
[plantuml,VereinReadService,svg]
----
...
.Die Service-Klasse "VereinWriteService" im Anwendungskern
[plantuml,VereinWriteService,svg]
----
...
.Die Entity-Klasse "Verein" für Vereindaten
[plantuml,Verein,svg]
----
