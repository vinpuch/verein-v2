...
-- (4) chown postgres:postgres /var/lib/postgresql/tablespace/verein
-- (5) exit
-- (6) docker compose down
-- (7) in docker-compose.yaml den User "postgres" wieder aktivieren
-- (8) docker compose up
-- (9) docker compose exec postgres bash
-- (10) psql --dbname=postgres --username=postgres --file=/sql/create-db-verein.sql
-- (11) exit
...
CREATE TABLESPACE kundespace OWNER verein LOCATION '/var/lib/postgresql/tablespace/verein';
